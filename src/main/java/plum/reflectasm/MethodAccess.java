...
public abstract class MethodAccess {
	...
	public static final String METHOD_ACCESS_LOCATION = "plum/reflectasm/MethodAccess";
	...
	static public MethodAccess get (Class type) {
		...
		synchronized (loader) {
			try {
				...
				MethodVisitor mv;
				cw.visit(V1_1, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null, METHOD_ACCESS_LOCATION,
					null);
				{
					mv = cw.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
					mv.visitCode();
					mv.visitVarInsn(ALOAD, 0);
					mv.visitMethodInsn(INVOKESPECIAL, METHOD_ACCESS_LOCATION, "<init>", "()V");
					mv.visitInsn(RETURN);
					mv.visitMaxs(0, 0);
					mv.visitEnd();
				}
