...
public abstract class FieldAccess {
	...
	public static final String FIELD_ACCESS_LOCATION = "plum/reflectasm/FieldAccess";
	...
	static public FieldAccess get (Class type) {
		...
		synchronized (loader) {
			try {
				...
				cw.visit(V1_1, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null, FIELD_ACCESS_LOCATION,
					null);
	...
	static private void insertConstructor (ClassWriter cw) {
		...
		mv.visitMethodInsn(INVOKESPECIAL, FIELD_ACCESS_LOCATION, "<init>", "()V");
		mv.visitInsn(RETURN);
		mv.visitMaxs(1, 1);
		mv.visitEnd();
	}
