 ...
 * @version 1.0 2013-01-02 1:21 PM
 * @since JDK 1.5
 */
public class ValidationErrorsHelper {
	...
	public static void convert(ConstraintViolationException exception, Errors errors) {
		ValidationErrorsHelper.convert(exception.getConstraintViolations(), errors);
	}
	...
	protected static Object[] getArgumentsForConstraint(String objectName, String field, ConstraintDescriptor<?> descriptor) {
		...
		Map<String, Object> attributesToExpose = Maps.newTreeMap();
